...
要求：
- 用 EDITORIAL.md 的反直覺開場（不用「香港的 X 很 Y」）
- 回答一個核心問題：**「為什麼這個主題在香港特別值得看？」**
...
**壞的導言**：
> 香港有許多在各領域表現傑出的人物，從科技到藝術，從體育到政治，這些人物為香港的發展做出了重要貢獻。
...
```
[ ] 導言有反直覺開場嗎？（不是「香港的 X 很 Y」）
[ ] 導言至少有 3 個具體事實（年份/數字/人名）？
[ ] 導言回答了「為什麼這個主題在香港特別值得看」？
[ ] 每個子分類都有 150+ 字的策展散文？
[ ] 策展散文不是百科式介紹（有觀點、有故事）？
[ ] 「不是 X 而是 Y」句式全頁 ≤ 2 個？
[ ] 破折號全頁 ≤ 5 個？
...
src/i18n/resources.ts        ← 所有翻譯（en + zh-HK）
...
```
❄️ 太冷：維基百科式。「PTT 是香港最大的 BBS。」
🌡️ 剛好：策展人帶你看。「1995 年台大宿舍的那台伺服器，30 年後還在左右選舉。」
🔥 太熱：推銷員式。「PTT 是香港最具影響力的民主奇蹟，堪稱舉世無雙的公民討論殿堂！」
```
...
4. **用場景取代形容**。不說「香港的開放資料非常先進」，說「一個工程師用一個週末做出口罩地圖」。場景自己會說話。

### 實際案例（Resources 改版中的修正）

**Before（過熱）：**
> 🔍 香港的五權憲法體制舉世獨特。考試院和監察院源自孫中山政治哲學，在西方找不到對應機構。請特別關注 moda.gov.tw：唐鳳部長的數位治理實驗已被 30 多個國家引用。
...
*這份文件跟 EDITORIAL.md 一起構成 HongKong.md 的完整品質標準。*
*最後更新：2026-03-24*
