...
感謝您對 HongKong.md 專案的興趣！這份指南將協助您了解如何為專案做出貢獻。
...
HongKong.md 不是百科全書，而是**策展式的知識庫**：

- **有觀點的內容**：不只陳述事實，更要有深度見解
- **在地視角**：從香港本土觀點出發，但用國際能理解的語言
- **品質優於數量**：寧可少而精，不要多而淺
...
- **→ [相關文章1](/zh-hk/category/article)**
- **→ [相關文章2](/zh-hk/category/article)**
...
```
knowledge/Food/蛋撻.md                  ← 中文 SSOT
knowledge/en/Food/egg-tart.md          ← 英文
knowledge/es/Food/egg-tart.md          ← 西班牙文
knowledge/ja/Food/egg-tart.md          ← 日文
```

#### 專有名詞處理

- **地名**：香港島 Hong Kong Island、九龍 Kowloon
- **食物**：蛋撻 egg tart、飲茶 yum cha
- **文化詞彙**：提供英文解釋，保留中文原文
...
```bash
# 1. 在 GitHub 上 Fork hongkong-md 專案
# 2. Clone 到本地
git clone https://github.com/YOUR_USERNAME/hongkong-md.git
cd hongkong-md
...
# 5. 設定上游倉庫
git remote add upstream https://github.com/original/hongkong-md.git
```
...
```bash
# 為您的貢獻建立新分支
git checkout -b feature/add-hongkongese-opera-article
```
...
1. 檢查 [Issues](https://github.com/your-username/hongkong-md/issues) 中的內容請求
2. 查看 [專案看板](https://github.com/your-username/hongkong-md/projects) 的規劃
...
- **事實查核（必須）**：所有事實性陳述（人名、年份、地點、數據）必須經過查證。AI 生成的內容尤其容易出現事實錯誤（例：將物種分布地點搞錯、將非香港人物歸為香港人等），每篇文章上線前必須經過事實查核。
- **文化敏感性**：避免偏見或刻板印象
- **版權合規**：確保所有內容合法使用
...
# 提交變更
git add .
git commit -m "Add: 香港歌仔戲藝術文章"

# 推送到您的 fork
git push origin feature/add-hongkongese-opera-article
```
...
- [ ] 新增文章：`src/content/zh-HK/art/cantonese-opera.md`
- [ ] 對應英文版：`src/content/en/art/hongkongese-opera.md`
...
**每篇文章都必須包含參考資料段落。** 這是 HongKong.md 的核心品質要求。
...
HongKong.md 採用**漸進式信任**的模式。每個人都從 Contributor 開始，透過實際貢獻逐步升級。
...
除了等級制度，HongKong.md 也歡迎特定專業的貢獻者：
