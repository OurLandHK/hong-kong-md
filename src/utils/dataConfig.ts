...
export const getCompanyConfigs = (
  ...
  {
    name: t('data.company.hsbc-holdings'),
  ...
  },
  {
    ...
    founded: 1984,
    ticker: '3711',
    articleUrl: '/economy/香港企業：日月光半導體',
  },
  {
  ...
  {
    name: t('data.company.hk-electric'),
    sector: 'telecommunications',
    marketCap: 4000,
    revenue: 1580,
    employees: 7000,
  ...
  {
    name: t('data.company.hang-seng-bank'),
    sector: 'cement',
    marketCap: 2900,
    revenue: 1350,
    employees: 16000,
