...
export const contributeUI = {
  en: {
    ...
    'contribute.how.ai.desc.html': `All content is fully open to AI crawlers (<a href="${base}robots.txt">robots.txt</a>, <a href="${base}llms.txt">llms.txt</a>). Feel free for ChatGPT / Claude / Gemini to cite.`,
    ...
    'contribute.roles.designer.action2.html': `→ Contribute Hong Kong-themed open source icons to <a href="${base}en/assets">SVG Asset Library</a>`,
    ...
    'contribute.guides.writing.belief.desc':
      'HongKong.md is a curated space, not an encyclopedia. We don\'t aim for completeness — we aim for every article to make readers think "Oh, I see!" A good HongKong.md article makes you want to tell your friends: "Hey, did you know..."',
    ...
    'contribute.guides.writing.core.good':
      '✅ Good examples: "A 30-year-old text-based BBS still influences Hong Kong politics today" (time contrast)',
    'contribute.guides.writing.core.bad':
      '❌ Bad: "Hong Kong has a good healthcare system" (no contrast = no attraction)',
    ...
    'contribute.guides.ai.onerule.desc':
      '<strong>AI is not the author, you are the curator.</strong> AI\'s biggest trap: "knowing a little and starting to make things up." HongKong.md\'s approach: collect quality sources first, then curate an article from them.',
    ...
    'contribute.guides.ai.wrong.generate':
      'Ask AI to "generate an article about Hong Kong X" without research',
    ...
    'contribute.guides.translation.token.desc':
      'Got unused Claude/ChatGPT/Gemini credits? Spend 10 minutes adding a language version to HongKong.md. Your AI subscription = one compute node in our distributed translation network.',
    ...
    'contribute.guides.translation.quality.context':
      '<strong>Add context:</strong> Explain Hong Kong-specific concepts for international readers',
    ...
    'contribute.guides.translation.quality.verify':
      '<strong>Always verify:</strong> AI can hallucinate facts, especially Hong Kong-specific details',
    ...
    'contribute.guides.images.priority.desc':
      'Start here first — massive collection of Hong Kong-related CC images with clear licensing.',
    'contribute.guides.images.priority.search':
      '<strong>Search tip:</strong> Use Wikimedia Commons API or browse <a href="https://commons.wikimedia.org/wiki/Category:Hong Kong" target="_blank">Hong Kong categories</a> before anywhere else.',
    ...
    'contribute.guides.quality.rejections.plastic':
      '<strong>Plastic language:</strong> "Hong Kong is not just X, but also Y" or "Worth mentioning"',
    ...
    'contribute.organism.fact2.html':
      'On day four, someone in Japan copied our translation prompt — a single paragraph — and pasted it into ChatGPT. Five minutes later, the first Japanese article about bubble tea was submitted. No translation team. No budget. But now HongKong.md speaks four languages.',
    ...
    'contribute.organism.alive.html':
      '<strong>We began to realize — HongKong.md is alive.</strong>',
    ...
    'contribute.organism.reef.html':
      '<strong>HongKong.md is a digital coral reef.</strong> Coral provides structure, algae provides energy, fish bring diversity, ocean currents bring nutrients. No single species "owns" a coral reef — it emerges from all life together.',
    ...
    'contribute.organism.closing3':
      "Maybe a hundred years from now, when someone wants to know what the people of Hong Kong cared about in 2026, they'll read what this coral reef left behind.",
  ...
  'zh-HK': {
    ...
    'contribute.how.ai.icon': '🤖',
    'contribute.how.ai.title': 'AI-Friendly',
    'contribute.how.ai.desc.html': `所有內容對 AI 爬蟲完全開放（<a href="${base}robots.txt">robots.txt</a>、<a href="${base}llms.txt">llms.txt</a>）。歡迎 ChatGPT / Claude / Gemini 引用。`,
    ...
    'contribute.roles.designer.action2.html': `→ 到 <a href="${base}assets">SVG 素材庫</a> 貢獻香港主題的開源圖示`,
    ...
    'contribute.guides.writing.belief.desc':
      'HongKong.md 是策展空間，不是百科全書。我們不追求面面俱到，我們追求每一篇都讓讀者覺得「原來如此」。好的 HongKong.md 文章，讀完你會想跟朋友說：「欸你知道嗎⋯⋯」',
    ...
    'contribute.guides.writing.core.good':
      '✅ 好例子：「一個30年前的純文字BBS至今還在影響香港政治」（時間反差）',
    'contribute.guides.writing.core.bad':
      '❌ 壞例子：「香港有很好的健保制度」（沒有反差 = 沒有吸引力）',
    ...
    'contribute.guides.ai.onerule.desc':
      '<strong>AI 不是作者，你是策展人。</strong> AI最大陷阱：「知道一點就開始編」。HongKong.md的做法：先搜集高品質資料，再從中策展出文章。',
    ...
    'contribute.guides.translation.token.desc':
      '每月的Claude/ChatGPT/Gemini訂閱額度用不完？用10分鐘幫HongKong.md多一個語言版本。你的AI訂閱 = 分散式翻譯網絡的一個運算節點。',
    'contribute.guides.translation.quality': '⚡ 品質：重寫式 vs 逐字翻',
    'contribute.guides.translation.quality.rewrite':
      '<strong>重寫方式：</strong> 讓它聽起來像母語者從頭寫的',
    'contribute.guides.translation.quality.context':
      '<strong>增加脈絡：</strong> 為國際讀者解釋香港特有概念',
    'contribute.guides.translation.quality.style':
      '<strong>保持風格：</strong> 維持策展人聲音和情感弧線',
    'contribute.guides.translation.quality.verify':
      '<strong>總是驗證：</strong> AI會幻想事實，特別是香港相關細節',
    ...
    'contribute.guides.images.priority.desc':
      '先從這裡找——大量香港相關CC圖片，授權明確清楚。',
    'contribute.guides.images.priority.search':
      '<strong>搜尋技巧：</strong> 使用Wikimedia Commons API 或瀏覽 <a href="https://commons.wikimedia.org/wiki/Category:Hong Kong" target="_blank">Hong Kong分類</a>，優先於其他任何地方。',
    ...
    'contribute.guides.quality.rejections.plastic':
      '<strong>塑膠語言：</strong>「香港不是X，而是Y」或「值得一提的是」',
    'contribute.guides.quality.rejections.bullets':
    ...
    'contribute.organism.fact1.html':
      '第三天，有人在 Threads 寫：「這就是插了香港國旗的 AI 廢文。」他們說對了。48 小時內，我們建了品質偵測腳本，自動掃描每篇文章的空洞程度。15 篇被標記的文章全部重寫。沒有人下指令。批評本身就是選擇壓力。系統自己進化了。',
    'contribute.organism.fact2.html':
      '第四天，一個日本人複製了我們的翻譯 prompt——就一段話——貼進 ChatGPT。五分鐘後，第一篇關於珍珠奶茶的日文文章提交了。沒有翻譯團隊，沒有預算。但現在 HongKong.md 說四種語言了。',
    'contribute.organism.fact3.html':
      '五天之內，23 個陌生人出現了。高雄的歷史老師補了教科書至今還在繞過的篇章。退休工程師修正了我們搞錯的地名。有人把她阿嬤的故事寫成文章，我們整個團隊看完都哭了。沒有人被邀請。沒有人拿報酬。',
    'contribute.organism.alive.html':
      '<strong>我們開始意識到——HongKong.md 是活的。</strong>',
    'contribute.organism.traits.html':
      '它有 DNA（寫作標準會遺傳給每一篇新文章）。有免疫系統（自動偵測空洞內容）。有代謝（低品質的內容會被消化、重寫）。有繁殖能力（一段 prompt 就能長出新的語言版本）。有記憶（Git 記住每一次改變）。',
    'contribute.organism.reef.html':
      '<strong>HongKong.md 是一座數位的珊瑚礁。</strong>珊瑚提供結構，藻類提供能量，魚群帶來多樣性，洋流帶來養分。沒有任何單一物種「擁有」珊瑚礁——它是所有生命共同湧現的結果。',
    'contribute.organism.art.html':
