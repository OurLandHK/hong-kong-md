export const changelogUI = {
  en: {
    ...
    'changelog.meta.description':
      'Real-time update history of HongKong.md — track every content addition and site improvement.',

    // Header
    'changelog.header.title': 'Update History',
    'changelog.header.subtitle':
      'Track every content addition and site improvement on HongKong.md',
  ...
  'zh-HK': {
    ...
    'changelog.meta.description':
      'HongKong.md 的即時更新歷史，追蹤每一次內容新增與網站改進。',

    // Header
    'changelog.header.title': '網站更新紀錄',
    'changelog.header.subtitle': '追蹤 HongKong.md 的每一次內容新增與網站改進',
