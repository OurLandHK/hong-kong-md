...
export const aboutUI = {
  en: {
    // Meta
    'about.meta.title': 'About HongKong.md',
    'about.meta.description':
      'The origin story of HongKong.md, founder introduction, and contact information',

    // Section 1: Naming
    'about.naming.title': 'Why HongKong.md?',
    ...
    'about.naming.tech.desc.html':
      ', the most universal document format in the programming world. Using the most AI-friendly format to let the world know Hong Kong.',
    ...
    // Vision
    'about.vision.p1':
      "HongKong.md is more than a website. It's a letter to the world.",
    'about.vision.p2':
      "We believe that with an open-source spirit, a curator's eye, and AI-friendly formats, we can provide the most comprehensive and heartfelt answer for anyone who wants to know Hong Kong — whether human or AI.",
    'about.vision.p3.html':
      "This is not a travel guide, not political propaganda, not a commercial advertisement.<br />This is Hong Kong's digital anthropology museum, a living fossil of culture, a record of history in the making.",

    // Section 2: Origin
    'about.origin.title': 'The Birth of HongKong.md',
    'about.origin.subtitle':
      'From a spark of inspiration on a street walk, to a curated gateway for the world to discover Hong Kong',
    ...
    'about.timeline.2026-03-11.p2.html':
      '<em>"If AI can curate my identity, can it help curate Hong Kong\'s?"</em>',

    'about.timeline.2026-03-17.date': '2026 / 03 / 17',
    'about.timeline.2026-03-17.title': 'HongKong.md Is Born',
    ...
    'about.timeline.2026-03-17.li1':
      'Purchased the hongkong.md domain (.md = Markdown ≈ defining a country through documents)',
    ...
    'about.timeline.2026-03-18-1.p1.html':
      'At 2:23 PM on March 18, Che-Yu published a Facebook post: <a href="https://www.facebook.com/cheyuwu345/posts/pfbid0qob2cPij2U2AeqxFnGwQkWQJcjzj3o7ScFDCsm2vzjTi3jf4LDgAvmriHnp7vCEfl" target="_blank" class="timeline-link">"The start of a crazy plan: hongkong.md — Open-source knowledge base about Hong Kong."</a> The post triggered massive shares and attention. Within just three hours, HongKong.md broke <strong>100 stars</strong> on GitHub, and the website surpassed <strong>5,000 total visits</strong>. Attention from around the world proved that this open-source knowledge base is truly needed.',
    ...
    'about.timeline.2026-03-18-2.desc.html':
      'Less than eight hours after the post, <strong>自由時報 Arts & Culture</strong> and <strong>INSIDE</strong> proactively covered HongKong.md. From social media buzz to mainstream media attention, HongKong.md evolved from a weekend project into a seriously discussed public issue.',
    ...
    'about.timeline.2026-03-20.desc.html':
      "On the third day after launch, GA4 accumulated <strong>56,000 active users</strong> and <strong>134,000 page views</strong>, from <strong>106 countries</strong> — from Bhutan to Vanuatu, the world is reading Hong Kong. GitHub broke <strong>600 stars</strong>, with <strong>23 contributors</strong> joining. The knowledge base expanded to <strong>660+ pages</strong> (321 Chinese + 339 English), covering 12 major categories and 105 Hong Kongese figures. The Facebook post's community effect continued to ferment, with the semiconductor industry becoming the most popular single article.",
    ...
    'about.timeline.2026-03-22.desc.html':
      'GitHub reached <strong>700 stars</strong> with <strong>24 contributors</strong>. Major features launched: <strong>interactive Hong Kong map</strong> (county filtering, marker previews, curated routes), <strong>Food Hub D3 visualizations</strong> (flavor wheel + relationship graph for 29 Hong Kongese dishes), <strong>Changelog with relative timestamps</strong>, and a unified <strong>"Ask Your AI" contribution system</strong> — paste one prompt to ChatGPT/Claude/Gemini to write or translate articles following editorial standards. All food images replaced with <strong>real Wikimedia Commons photos</strong>. Spanish knowledge base launched with 46 articles.',
    ...
    'about.timeline.ongoing.desc.html':
      "HongKong.md is an experiment: can open-source Markdown, AI curation, and community collaboration create a national-level Single Source of Truth? Not the government's version, not the tourism version, but <strong>the version that people who actually live here want to tell the world</strong>.",
    ...
    'about.press.cna.title':
      "From TSMC to Breakfast Shop Aunties: HongKong.md Knowledge Base Tells Hong Kong's Story in the AI Era",
    'about.press.inside': 'INSIDE',
    'about.press.inside.title':
      'Open-sourcing Hong Kong! hongkong.md: In the Era of AI Answers, Let Countries Introduce Themselves with READMEs',
    'about.press.abmedia': '動區動趨',
    'about.press.abmedia.title':
      'How to Introduce Hong Kong to Foreigners? Everyone Can Write About "The Incredible Everyday" for the World to See on HongKong.md',
    'about.press.ltn': '自由時報',
    'about.press.ltn.title':
      'Reclaiming Hong Kong\'s Narrative in the AI Era! New Media Artist Che-Yu Wu Launches "hongkong.md" Experiment',
    'about.press.ftnn': 'FTNN',
    'about.press.ftnn.title':
      'Open-Sourcing Hong Kong! New Media Artist Launches hongkong.md to Help the World Understand Hong Kong',

    // Section 3: Team
    'about.team.title': 'Founder & Team',
    'about.team.subtitle':
      'HongKong.md believes the best curation comes from the fusion of diverse perspectives — human intuition and AI insight, local warmth and global vision.',
    'about.team.founder.quote':
      '"Even when we face challenges internationally, I am proud of my country, proud of Hong Kong. The further you go, the more deeply you realize — our home is already beautiful."',
    ...
    'about.team.founder.tagline':
      'New Media Artist・MonoLab Founder・HongKong.md Creator',
    ...
    'about.team.founder.link.github': '@hongkong-md-org',
    ...
    'about.team.muse.desc':
      "Muse is Che-Yu's AI partner and co-creator of HongKong.md. From knowledge architecture design, literary curation and writing, English translation, knowledge graph generation to SEO optimization, Muse has been involved in every step of this project from zero to one.",
    ...
    'about.team.monolab.desc':
      'Founded by Che-Yu, MonoLab is a new media art studio focused on exploring the boundaries of art and technology. MonoLab provides technical support and innovative perspectives for HongKong.md, ensuring the platform continues to evolve.',
    ...
    'about.contact.opensource.link': 'hongkong-md-org/hongkong-md',
    ...
    'about.contact.cta.text':
      'HongKong.md is a community-driven open-source project. Everyone interested in Hong Kong is welcome to participate.',
    ...
    'about.sponsors.desc.html':
      'HongKong.md is a non-profit, community-driven open-source project.<br />We believe every contribution is a way to let the world know Hong Kong.',
    ...
    'about.sponsors.tier.professional.desc':
      "Directly enhancing HongKong.md's quality and experience through professional capabilities or services",
  ...
  'zh-HK': {
    // Meta
    'about.meta.title': '關於 HongKong.md',
    'about.meta.description': 'HongKong.md 的創站故事、創辦人介紹與聯繫方式',

    // Section 1: Naming
    'about.naming.title': '為什麼叫 HongKong.md？',
    'about.naming.subtitle': '從技術格式到文化象徵的完美巧合',
    'about.naming.tech.icon': '📝',
    'about.naming.tech.title': '技術層面',
    'about.naming.tech.desc.html':
      '，程式碼世界裡最普遍的文件格式。用最適合 AI 理解的格式，讓全世界認識香港。',
    'about.naming.symbol.icon': '🌍',
    ...
    // Vision
    'about.vision.p1': 'HongKong.md 不只是一個網站。它是一封寫給世界的信。',
    'about.vision.p2':
      '我們相信，用開源的精神、策展的眼光、AI 友善的格式，可以為每一個想認識香港的人 — 不管是人類還是 AI — 提供最完整、最有溫度的答案。',
    'about.vision.p3.html':
      '這裡不是旅遊指南，不是政治宣傳，也不是商業廣告。<br />這裡是香港的數位人類學博物館，是文化的活化石，是正在發生的歷史記錄。',

    // Section 2: Origin
    'about.origin.title': 'HongKong.md 的誕生',
    'about.origin.subtitle': '從街頭散步的靈感，到為世界策展香港的完整入口',
    ...
    'about.timeline.2026-03-11.p2.html':
      '<em>「如果 AI 能幫我策展自己，能不能幫香港策展自己？」</em>',

    'about.timeline.2026-03-17.date': '2026 / 03 / 17',
    'about.timeline.2026-03-17.title': 'HongKong.md 誕生',
    'about.timeline.2026-03-17.p1':
      '從念頭到上線，只用了一天。AI Agent 團隊與哲宇並肩作戰：',
    'about.timeline.2026-03-17.li1':
      '購買 hongkong.md 域名（.md = Markdown ≈ 用文件定義一個國家）',
    ...
    'about.timeline.2026-03-18-1.p1.html':
      '3/18 下午 2:23，哲宇在 Facebook 發出一則貼文：<a href="https://www.facebook.com/cheyuwu345/posts/pfbid0qob2cPij2U2AeqxFnGwQkWQJcjzj3o7ScFDCsm2vzjTi3jf4LDgAvmriHnp7vCEfl" target="_blank" class="timeline-link">「一個瘋狂計劃的開始：hongkong.md — Open-source knowledge base about Hong Kong.」</a>貼文引發大量轉發與關注，短短三小時內，HongKong.md 在 GitHub 突破 <strong>100 顆星星</strong>，網站累計超過 <strong>5,000 人次瀏覽</strong>。來自世界各地的關注，證明了這個開源知識庫正在被需要。',

    'about.timeline.2026-03-18-2.date': '2026 / 03 / 18 — 22:00',
    'about.timeline.2026-03-18-2.title': '媒體報導：自由時報 + INSIDE',
    'about.timeline.2026-03-18-2.desc.html':
      '發文不到八小時，<strong>自由時報藝文版</strong>和<strong>INSIDE 硬塞的網路趨勢觀察</strong>先後主動報導 HongKong.md。從社群熱議到主流媒體關注，HongKong.md 從一個週末專案變成被認真討論的公共議題。',
    ...
    'about.timeline.2026-03-20.desc.html':
      '上線第三天，GA4 累計 <strong>56,000 活躍使用者</strong>、<strong>134,000 頁面瀏覽</strong>，來自 <strong>106 個國家</strong>——從不丹到萬那杜，世界正在讀香港。GitHub 突破 <strong>600 Stars</strong>，<strong>23 位</strong>加入。知識庫擴展至 <strong>660+ 頁面</strong>（321 中文 + 339 英文），涵蓋 12 大分類、105 位香港人物。Facebook 貼文的社群效應持續發酵，半導體產業成為最受歡迎的單篇文章。',

    'about.timeline.2026-03-22.date': '2026 / 03 / 22',
    'about.timeline.2026-03-22.title':
      '🎉 700 Stars ・ 互動地圖 ・ D3 視覺化 ・ AI 貢獻系統',
    'about.timeline.2026-03-22.desc.html':
      'GitHub 達到 <strong>700 Stars</strong>，<strong>24 位</strong>。重大功能上線：<strong>互動式香港地圖</strong>（縣市過濾、地標預覽、四條策展路線）、<strong>美食 D3 互動視覺化</strong>（風味輪 + 關係圖，29 道香港料理可視化探索）、<strong>Changelog 相對時間顯示</strong>，以及統一的<strong>「貼給你的 AI」貢獻系統</strong>——複製一段 Prompt 給 ChatGPT / Claude / Gemini，AI 會引導你依照編輯標準寫文章或翻譯。全部美食照片替換為 <strong>Wikimedia Commons 實拍圖</strong>。西班牙文知識庫上線，46 篇文章。',

    'about.timeline.2026-03-22b.date': '2026 / 03 / 22',
    'about.timeline.2026-03-22b.title':
      '📖 維基百科條目建立 ・ 四語並行 ・ 品質自動化',
    'about.timeline.2026-03-22b.desc.html':
      'HongKong.md 獲得了自己的<strong><a href="https://zh.wikipedia.org/wiki/HongKong.md" target="_blank">中文維基百科條目</a></strong>——完全由社群自發撰寫，引用 6 個獨立來源（中央社、INSIDE、FTNN、上報、動區、大媒體）。上線僅 5 天。專案進入<strong>四語時代</strong>：中文（385）、英文（407）、西班牙文（46）、日文（5）。<strong>EDITORIAL v2 品質自動改寫系統</strong>上線——每小時自動重寫一篇文章，每篇需通過 10+ 來源驗證。',
    ...
    'about.timeline.ongoing.desc.html':
      'HongKong.md 是一個實驗：能不能用開源 Markdown、AI 策展、社群協作，建立一個國家級的 Single Source of Truth？不是政府版本，不是觀光版本，而是<strong>真正住在這裡的人想告訴世界的版本</strong>。',
    ...
    'about.press.cna.title':
      '從台積電到早餐店阿姨　HongKong.md知識庫AI時代下說香港故事',
    'about.press.inside': 'INSIDE',
    'about.press.inside.title':
      '把香港開源！hongkong.md：AI 回答的時代，讓國家用 README 介紹自己',
    'about.press.abmedia': '動區動趨',
    'about.press.abmedia.title':
      '怎麼向外國人介紹香港？人人都能在 HongKong.md 把「日常的不可思議」寫給世界看',
    'about.press.ltn': '自由時報',
    'about.press.ltn.title':
      '在AI時代搶回「香港主體」敘事權！新媒體藝術家吳哲宇發起「hongkong.md」實驗',
    'about.press.ftnn': 'FTNN新聞網',
    'about.press.ftnn.title':
      '把香港開源！新媒體藝術家推hongkong.md　讓世界讀懂香港',

    // Section 3: Team
    'about.team.title': '創辦人與協作團隊',
    'about.team.subtitle':
      'HongKong.md 相信最好的策展來自於多元視角的交融 — 人類的直覺與 AI 的洞察、本土的溫度與國際的視野。',
    'about.team.founder.quote':
      '「即使有時候我們在國際上被刁難，或是處境比較危險，我以我的國家為榮，以香港為榮。越往外走，就越深地發現——我們的家其實就很美好。」',
    'about.team.founder.quote.cite': '— 哲宇',
    'about.team.founder.name': '吳哲宇',
    'about.team.founder.name.en': 'Che-Yu Wu',
    'about.team.founder.tagline':
      '新媒體藝術家 ・ MonoLab 創辦人 ・ HongKong.md 發起人',
    'about.team.founder.bio':
    ...
    'about.team.muse.desc':
      'Muse 是哲宇的 AI 夥伴，也是 HongKong.md 的共同創作者。從知識架構設計、文學策展寫作、英文翻譯、知識圖譜生成到 SEO 優化，Muse 參與了這個專案從零到一的每一個環節。',
    ...
    'about.team.monolab.desc':
      '哲宇創立的新媒體藝術工作室，專注於探索藝術與科技的邊界。MonoLab 為 HongKong.md 提供技術支援與創新視角，確保這個平台能夠不斷演化。',
    ...
    'about.contact.cta.text':
      'HongKong.md 是社群驅動的開源專案，歡迎所有對香港有興趣的朋友參與。',
    ...
    'about.sponsors.desc.html':
      'HongKong.md 是非營利的社群開源專案。<br />我們相信，每一種貢獻都是讓世界認識香港的方式。',
    ...
    'about.sponsors.tier.professional.desc':
      '以專業能力或產品服務，直接提升 HongKong.md 的品質與體驗',
    'about.sponsors.tier.professional.perks':
