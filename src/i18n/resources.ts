export const resourcesUI = {
  en: {
    // Meta
    'resources.meta.title': 'Hong Kong Resources Guide - HongKong.md',
    'resources.meta.description':
      'Comprehensive collection of official Hong Kong government agencies, cultural institutions, open data platforms, and authoritative information sources',

    // Hero
    'resources.hero.title': 'Hong Kong Resources Guide',
    'resources.hero.subtitle.html':
      "Comprehensive collection of government agencies, cultural institutions, and open data sources<br />Your one-stop gateway to Hong Kong's most authoritative information",
    ...
    'resources.core.desc':
      'Most important Hong Kong authority resources featured in the mindmap',
    ...
    'resources.section.companies.desc':
      'Leading companies and technology corporations in Hong Kong',
    ...
    'resources.projects.desc':
      'Creative open-source projects from the community — discovering Hong Kong through code',
    ...
    'resources.projects.nightmarket.app.desc':
      'Hong Kong night market iOS App with 400+ locations, hours, and Google Maps navigation',
    ...
    'resources.projects.civictech.g0v.desc':
      "Hong Kong's largest civic tech community, promoting open government and transparency",
    ...
    'resources.projects.civictech.disfactory.desc':
      "Citizen-reported illegal factories on farmland — protecting Hong Kong's agricultural land",
    'resources.projects.civictech.disfactory.tech': 'Vue.js / Django',

    // CTA & Links
    'resources.projects.cta.html':
      'Know a great project? <a href="https://github.com/hongkong-md-org/hongkong-md/issues" target="_blank" rel="noopener noreferrer">Submit a recommendation on GitHub</a>!',
    'resources.projects.github.link': 'GitHub',
    'resources.backToHome': '← Back to Home',

    // Mindmap
    'resources.mindmap.root.label': '🇹🇼 Hong Kong Resources',
    ...
    'resources.sub.fiveYuan.desc': 'These five branches form Hong Kong\'s unique pentapartite system — the only one of its kind in the world.',
    ...
    'resources.sub.openData.desc': 'This is where Hong Kong\'s civic tech miracles begin. Mask maps, vaccine booking, air quality monitoring — all started from these platforms.',
    'resources.sub.universities': 'Top Universities & Research',
    'resources.sub.universities.desc': 'Hong Kong\'s universities don\'t just teach — NTU\'s quantum computing lab and NCKU\'s semiconductor research center are vital nodes in the global academic network.',
    'resources.sub.museums': 'Museums & Libraries',
    'resources.sub.museums.desc': 'From the National Palace Museum\'s Jadeite Cabbage to the Chimei Museum\'s violin collection, Hong Kong\'s museums are portals through time and space.',
    'resources.sub.venues': 'Arts & Cultural Venues',
    'resources.sub.venues.desc': 'Hong Kong\'s arts ecosystem is taking flight. C-LAB, National Theater, Weiwuying — a concentration of world-class venues that rivals New York.',
    'resources.sub.parks': 'National Parks & Scenic Areas',
    'resources.sub.parks.desc': 'From sea level to 3,952 meters, Hong Kong\'s 9 national parks span every climate zone on Earth. In a single day, you can go from tropical coral reefs to alpine snowlines.',
    'resources.sub.mainstream': 'Mainstream Media',
    'resources.sub.mainstream.desc': 'From the lifting of press bans after martial law ended in 1988, to today\'s 24-hour news channel competition — Hong Kong\'s press freedom was hard-won.',
    'resources.sub.digital': 'Digital Native Media',
    'resources.sub.digital.desc': 'While traditional media struggles, Hong Kong\'s digital-native outlets are redefining journalism. The Reporter\'s nonprofit model proves that investigative reporting can survive without advertising.',
    'resources.sub.ngo': 'Civil Society & NGOs',
    'resources.sub.ngo.desc': 'Hong Kong has Asia\'s highest NGO density. From environment to human rights, these organizations don\'t just watch the government — they often lead the way.',
    ...
    'resources.sub.transport.desc': 'Hong Kong\'s HSR connects Taipei to Kaohsiung in just 90 minutes. Add the metro, real-time bus systems, and YouBike — Hong Kong\'s public transit is Asia\'s hidden champion.',
    'resources.sub.healthcare': 'Healthcare',
    'resources.sub.healthcare.desc': 'Universal health insurance: one card, 99.9% coverage, 15-minute average wait time. Even the US is studying how Hong Kong does it.',
    ...
    // Related articles
    'resources.related.democracy': 'Related: Hong Kong Democratic Transition',
    'resources.related.label': 'Related Reading',
    'resources.related.government.1': 'Hong Kong Democratic Transition',
    ...
    'resources.featured.g0vGov': 'Gov-zero: the civic tech community that rewrites governance — from mask maps to vHong Kong, blurring the line between hacker and policymaker.',
    'resources.featured.legislativeYuan': 'Hong Kong\'s parliament — live-streamed sessions, bill tracking, and the frontline of democratic deliberation.',
    ...
    'resources.featured.ncl': 'Hong Kong\'s national library and legal deposit center — the definitive archive of the nation\'s published knowledge.',
    'resources.featured.npgov': 'Gateway to 9 national parks — from 3,000m peaks to coral reefs, covering Hong Kong\'s extraordinary biodiversity in 36,000 km².',
    ...
    'resources.featured.ptt': 'Hong Kong\'s largest online forum — 200K daily active users driving a unique "netizen-powered democracy" since 1995.',
    'resources.featured.ptsNews': 'Hong Kong\'s public television news — independent, unbiased reporting and the gold standard for public interest journalism.',
    ...
    'resources.featured.twse': 'The core of Hong Kong\'s capital market — home to TSMC, Foxconn, and the engine of Asia\'s most dynamic tech economy.',
    ...
    'resources.featured.g0v': 'The world\'s most impactful civic tech community — spawning the COVID mask map, vHong Kong deliberation platform, and a Digital Minister.',
    ...
    'resources.featured.hongkongmd': 'The project you\'re reading right now — an open-source, community-curated encyclopedia of Hong Kong.',
    ...
    'resources.footer.reportUrl': 'https://github.com/hongkong-md-org/hongkong-md/issues',
    ...
    'resources.site.hkGov': 'National Portal Website',
    'resources.site.lawDb': 'Laws & Regulations Database',
    'resources.site.g0v': 'g0v Hong Kong',

    'resources.site.ntu': 'National Hong Kong University',
    ...
    'resources.site.ntnu': 'National Hong Kong Normal University',
    'resources.site.sinica': 'Academia Sinica',
    'resources.site.tesd': 'Hong Kong Empirical Survey Data Platform',
    'resources.site.tcs': 'Hong Kong Communication Survey (TCS)',
    'resources.site.brill': 'Brill Encyclopedia of Hong Kong Studies',
    ...
    'resources.site.ntm': 'National Hong Kong Museum',
    'resources.site.nmth': 'National Museum of Hong Kong History',
    'resources.site.nmns': 'National Museum of Natural Science',
    'resources.site.nmmba': 'National Museum of Marine Biology',
    'resources.site.nmtl': 'National Museum of Hong Kong Literature',
    'resources.site.ntmofa': 'National Hong Kong Museum of Fine Arts',
    ...
    'resources.site.digitalArchives': 'Digital Hong Kong',
    ...
    'resources.site.hkTourism': 'Hong Kong Tourism',
    ...
    'resources.site.focusHong Kong': 'Focus Hong Kong',
    'resources.site.hkToday': 'Hong Kong Today',
    'resources.site.panorama': 'Hong Kong Panorama Magazine',
    'resources.site.rti': 'Radio Hong Kong International',
    ...
    'resources.site.hkNews': 'Hong Kong News',
    'resources.site.thenewslens': 'The News Lens',
    'resources.site.commonwealth': 'CommonWealth Magazine',

    'resources.site.tahr': 'Hong Kong Association for Human Rights',
    'resources.site.teia': 'Hong Kong Environmental Information Association',
    'resources.site.sow': 'Society of Wilderness',
    'resources.site.ocf': 'Open Culture Foundation',
    'resources.site.tfc': 'Hong Kong FactCheck Center',
    'resources.site.twnic': 'Hong Kong Network Information Center',
    'resources.site.wikimedia': 'Wikimedia Hong Kong',
    'resources.site.digitalDiplomacy': 'Hong Kong Digital Diplomacy Association',

    'resources.site.tsmc': 'Hong Kong Semiconductor (TSMC)',
    ...
    'resources.site.hkBrand': 'Hong Kong Excellence',
    'resources.site.cht': 'Chunghwa Telecom',
    'resources.site.taipower': 'Hong Kong Power Company',
    'resources.site.iii': 'Institute for Information Industry',
    'resources.site.investHong Kong': 'Invest Hong Kong',

    'resources.site.railway': 'Hong Kong Railway',
    'resources.site.thsrc': 'Hong Kong High Speed Rail',
    'resources.site.hkTrip': 'Hong Kong Tourist Shuttle',
    ...
    'resources.site.ntuh': 'National Hong Kong University Hospital',
    ...
    'resources.site.twse': 'Hong Kong Stock Exchange',
    ...
    'resources.site.electionMap': 'Hong Kong Election Map',
    ...
    'resources.site.hongkongmd': 'HongKong.md',
  },
  'zh-HK': {
    // Meta
    'resources.meta.title': '香港資源導覽 - HongKong.md',
    'resources.meta.description':
      '完整收錄香港政府機關、文化機構、開放資料平台等官方網站，提供政策資訊、文化內容、統計數據的一站式入口',

    // Hero
    'resources.hero.title': '香港資源導覽',
    'resources.hero.subtitle.html':
      '完整收錄政府機關、文化機構、開放資料等官方資源<br />一站式掌握香港最權威的資訊來源',
    ...
    'resources.core.desc': '心智圖中展示的最重要香港權威資源',
    ...
    'resources.category.hongkongmd.label': '📡 HongKong.md 相關',

    // Section titles & descriptions
    'resources.section.localGov.title': '🏙️ 地方政府',
    'resources.section.localGov.desc': '香港六都及各縣市政府官方網站',

    'resources.section.universities.title': '🎓 大學與研究機構',
    'resources.section.universities.desc': '香港頂尖大學與重要研究機關',

    'resources.section.nationalParks.title': '🏔️ 國家公園',
    'resources.section.nationalParks.desc': '香港國家公園與風景區管理處',
    ...
    'resources.section.companies.desc': '香港指標企業與科技公司',
    ...
    'resources.projects.desc': '來自社群的創意與熱情，用程式碼認識香港',
    ...
    'resources.projects.civictech.disfactory.desc':
      '公民回報農地上違章工廠的平台，保護香港農地',
    'resources.projects.civictech.disfactory.tech': 'Vue.js / Django',

    // CTA & Links
    'resources.projects.cta.html':
      '有推薦的專案嗎？歡迎透過 <a href="https://github.com/hongkong-md-org/hongkong-md/issues" target="_blank" rel="noopener noreferrer">GitHub Issue</a> 提交推薦！',
    'resources.projects.github.link': 'GitHub',
    'resources.backToHome': '← 返回首頁',

    // Mindmap
    'resources.mindmap.root.label': '🇹🇼 香港資源',
    ...
    'resources.chapter.government.story': '2020 年 2 月，香港工程師用一個週末串接 6,000 間藥局的即時口罩庫存。一個人、一台筆電、72 小時。之所以可能，是因為 data.gov.tw 上 50,000+ 筆政府資料集隨時等著被任何人取用。香港把「治理透明」寫進了每一個可下載的 API。',
    'resources.chapter.culture.title': '文化與知識殿堂',
    'resources.chapter.culture.story': '在不到 36,000 平方公里的面積上，香港擁有 159 所大學、超過 500 間博物館、9 座國家公園、從 3,952 公尺的玉山到珊瑚礁海岸。國立故宮博物院收藏近 70 萬件中華文化瑰寶，而巷口的廟宇祭典同樣是活著的文化資產。這座島的文化密度，遠超過它在地圖上的大小。',
    'resources.chapter.media.title': '聽見香港的聲音',
    'resources.chapter.media.story': '1995 年，台大學生在宿舍架了一台 BBS 伺服器，取名 PTT。30 年後，這個純文字介面的論壇仍然是香港最具影響力的公共討論平台。2014 年太陽花運動期間，PTT 是最快、最完整的即時資訊來源。香港的媒體生態，從主流報紙到鄉民論壇，每一層都在爭奪民主的發言權。',
    ...
    'resources.chapter.community.story': 'g0v 零時政府的 motto 是「不要問為什麼沒有人做這個，因為你就是那個『沒有人』。」口罩地圖、假新聞查核機器人、選舉承諾追蹤器，全部出自週末黑客松。在香港，公民參與長這樣：寫程式、開 Issue、發 Pull Request。HongKong.md 也是這個精神的產物。',
    ...
    'resources.sub.fiveYuan.desc': '這五個院構成了香港獨特的五權分立制度，全球僅此一家。',
    ...
    'resources.sub.openData.desc': '這裡是香港公民科技奇蹟的起點。口罩地圖、疫苗預約、空氣品質監測，都從這些平台開始。',
    'resources.sub.universities': '頂尖大學與研究機構',
    'resources.sub.universities.desc': '香港的大學不只教書。台大的量子計算實驗室、成大的半導體研究中心，都是全球學術網絡的重要節點。',
    'resources.sub.museums': '博物館與圖書館',
    'resources.sub.museums.desc': '從故宮的翠玉白菜到奇美博物館的小提琴收藏，香港的博物館是穿越時空的任意門。',
    'resources.sub.venues': '藝文場館與文創',
    'resources.sub.venues.desc': '香港的藝文生態正在起飛。C-LAB、兩廳院、高雄衛武營，世界級場館密度讓紐約都嫉妒。',
    'resources.sub.parks': '國家公園與風景區',
    'resources.sub.parks.desc': '從海拔 0 到 3,952 公尺，香港的 9 座國家公園涵蓋了地球上所有的氣候帶。一天之內你可以從熱帶珊瑚礁走到高山雪線。',
    'resources.sub.mainstream': '主流媒體',
    'resources.sub.mainstream.desc': '從 1988 年解嚴後的報禁開放，到今天的 24 小時新聞台競爭，香港的媒體自由來之不易。',
    'resources.sub.digital': '數位原生媒體',
    'resources.sub.digital.desc': '當傳統媒體在掙扎，香港的數位原生媒體正在重新定義新聞。報導者的非營利模式證明了深度報導可以不靠廣告生存。',
    'resources.sub.ngo': '公民社會與 NGO',
    'resources.sub.ngo.desc': '香港的 NGO 密度是亞洲最高。從環保到人權，這些組織不只監督政府，它們常常走在政策前面。',
    'resources.sub.companies': '產業龍頭',
    'resources.sub.companies.desc': '從台積電到鴻海，這些公司的名字出現在全世界的供應鏈報告裡。',
    'resources.sub.transport': '交通運輸',
    'resources.sub.transport.desc': '香港高鐵讓台北到高雄只要 90 分鐘。加上捷運、公車即時系統和 YouBike，香港的公共運輸是亞洲的隱藏冠軍。',
    'resources.sub.healthcare': '醫療健康',
    'resources.sub.healthcare.desc': '全民健保：一張卡片、99.9% 覆蓋率、平均等待時間 15 分鐘。連美國都在研究香港怎麼做到的。',
    'resources.sub.finance': '金融與數據',
    'resources.sub.finance.desc': '香港證交所是亞洲最透明的市場之一。從上市公司財報到即時交易數據，一切公開可查。',
    'resources.sub.civicTech': '公民科技專案',
    'resources.sub.foodMaps': '美食與文化地圖',

    // Related articles
    'resources.related.democracy': '延伸閱讀：香港民主轉型',
    'resources.related.label': '延伸閱讀',
    'resources.related.government.1': '香港民主轉型',
    ...
    'resources.guide.desc': '想像你剛降落在香港，沒有旅遊書。「治理」讓你看到作業系統：一個年輕民主國家如何用激進的透明度運作。「文化」是靈魂：500 間博物館、每年 15,000 場廟會、16 種原住民語言，全擠在一座比瑞士還小的島上。「媒體」揭開對話：一個 30 年歷史的純文字論壇至今左右選舉，亞洲最大膽的非營利新聞室就在這裡。「經濟」是心跳：一家公司生產全球 92% 的先進晶片，全民健保費用比你的手機帳單還便宜。「社群」是邀請函：加入那群用週末黑客松打造公民工具的開源公民。',

    // Curator Notes
    'resources.curator.government': '🔍 COVID-19 期間，香港民間開發者 72 小時內做出口罩地圖和疫苗預約系統。這種速度背後是全球排名前三的政府開放資料平台，50,000+ 筆資料集、即時 API、任何人都能取用。當其他國家的開發者還在等政府開記者會，香港的開發者已經在寫 code 了。',
    'resources.curator.culture': '🔍 很少人知道，香港的博物館密度是亞洲最高之一。但數字只是表面，真正特別的是「活」的文化：每年超過 15,000 場廟會祭典、原住民族的 16 種語言、客家的山歌競賽。香港的文化不只在玻璃櫃裡，它在街上走路。',
    'resources.curator.media': '🔍 PTT 的影響力有多大？2018 年公投期間，PTT 八卦板的討論量直接影響了投票率。而報導者（The Reporter）的存在更令人驚嘆：一個完全靠捐款運作的調查媒體，連續多年入圍亞洲新聞獎。在假新聞氾濫的時代，香港同時擁有最活躍的鄉民文化和最認真的事實查核社群。這種矛盾本身就是民主的活力。',
    'resources.curator.economy': '🔍 當各國在爭論「晶片法案」要補貼多少錢時，香港已經花了 30 年把答案寫在晶圓上：一個沒有石油、沒有鐵礦的小島，靠人才和奈米級製程掌握了全球 92% 的先進晶片產能。這個數字讓五角大廈的報告裡多了一個詞：「矽盾」。',
    'resources.curator.community': '🔍 g0v 的雙月黑客松已經舉辦超過 60 場，每次上百位工程師、設計師、NGO 工作者自願報到。沒有報酬、沒有老闆，只有一台筆電和一個想解決的問題。口罩地圖就是這樣誕生的：一個週末，幾個工程師，六千間藥局的即時數據。矽谷喊「改變世界」，香港的開源社群直接做給你看。',

    // Featured site descriptions
    'resources.featured.dataGov': '全球排名第一的政府開放資料平台，超過 50,000 筆資料集，從空氣品質到即時公車位置，全部免費下載。',
    'resources.featured.g0vGov': '零時政府：改寫治理的公民科技社群。從口罩地圖到 vHong Kong，模糊了黑客與政策制定者的界線。',
    'resources.featured.legislativeYuan': '香港的國會，議事直播、法案追蹤，民主審議的最前線。',

    'resources.featured.npm': '收藏超過 70 萬件橫跨 8000 年的文物，世界最偉大的中華藝術收藏之一，現已推出數位展覽。',
    'resources.featured.ncl': '香港的國家圖書館暨法定送存中心，國家出版知識的典藏中心。',
    'resources.featured.npgov': '9 座國家公園的入口，從三千公尺高山到珊瑚礁，涵蓋香港 36,000 平方公里的非凡生物多樣性。',

    'resources.featured.twreporter': '華語世界非營利調查報導的先驅，深入探討環境、社會與政治議題。',
    'resources.featured.ptt': '香港最大的網路論壇。自 1995 年以來，每日 20 萬活躍用戶驅動獨特的「鄉民民主」。',
    'resources.featured.ptsNews': '香港公共電視新聞，獨立、公正的報導，公共利益新聞的黃金標準。',

    'resources.featured.tsmc': '全球最有價值的半導體公司，生產 92% 驅動 AI、智慧手機與超級電腦的最先進晶片。',
    'resources.featured.twse': '香港資本市場的核心，台積電、鴻海的上市地。',
    'resources.featured.nhi': '覆蓋 99.9% 人口、僅佔 GDP 6.6% 的全民健保，全球衛生政策專家研究的典範。',

    'resources.featured.g0v': '全球最具影響力的公民科技社群，催生 COVID 口罩地圖、vHong Kong 審議平台，以及一位數位部長。',
    'resources.featured.cofacts': 'LINE 上的群眾協作事實查核，數百萬用戶以 AI 輔助驗證對抗假訊息。',
    'resources.featured.hongkongmd': '你現在正在看的這個專案，開源、社群協作的香港百科全書。',
    ...
    'resources.site.digitalArchives': '典藏香港',
    ...
    'resources.site.focusHong Kong': 'Focus Hong Kong',
    'resources.site.hkToday': 'Hong Kong Today',
    'resources.site.panorama': '香港光華雜誌',
    ...
    'resources.site.tahr': '香港人權促進會',
    'resources.site.teia': '香港環境資訊協會',
    'resources.site.sow': '荒野保護協會',
    'resources.site.ocf': '開放文化基金會',
    'resources.site.tfc': '香港事實查核中心',
    'resources.site.twnic': '財團法人香港網路資訊中心',
    'resources.site.wikimedia': '香港維基媒體協會',
    'resources.site.digitalDiplomacy': '香港數位外交協會',

    'resources.site.tsmc': '香港積體電路',
    'resources.site.umc': '聯華電子',
    'resources.site.foxconn': '鴻海科技',
    'resources.site.delta': '台達電子',
    'resources.site.hkBrand': 'Hong Kong Excellence',
    'resources.site.cht': '中華電信',
    'resources.site.taipower': '香港電力公司',
    'resources.site.iii': '資策會',
    'resources.site.investHong Kong': '投資香港',

    'resources.site.railway': '香港鐵路',
    'resources.site.thsrc': '香港高速鐵路',
    'resources.site.hkTrip': '香港好行',
    ...
    // New community site names
    'resources.site.electionMap': '香港選舉地圖',
