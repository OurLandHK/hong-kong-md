...
declare -A hub_info=(
    ...
    ["geography"]="香港地理|香港位於亞洲大陸邊緣，面積雖小但地形多樣，從海平面到近4000公尺高山。"
...
for hub_file in src/content/zh-HK/*/_{Art,Culture,Economy,Food,Geography,History,Lifestyle,Music,Nature,People,Society,Technology}\ Hub.md; do
    if [ -f "$hub_file" ]; then
